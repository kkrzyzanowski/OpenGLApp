...
void GUIWindow::RunGUIWindow(short int x, short int y)
{
	...
	GLFWwindow* window = glfwCreateWindow(x, y, "Dear ImGui GLFW+OpenGL3 example", NULL, NULL);
	if (window == NULL)
		return;
